...
`Link to Example 1 <https://nbviewer.jupyter.org/github/ozgesurer/surmisedevelopment/blob/main/examples/Example1/Example1_nb.ipynb>`_.
...
`Link to Example 2 <https://nbviewer.jupyter.org/github/ozgesurer/surmisedevelopment/blob/main/examples/Example2/Example2_nb.ipynb>`_.
...
`Link to Example 3 <https://nbviewer.jupyter.org/github/ozgesurer/surmisedevelopment/blob/main/examples/Example3/Example3_nb.ipynb>`_.
...
`Link to Example 4 <https://nbviewer.jupyter.org/github/ozgesurer/surmisedevelopment/blob/main/examples/Example4/Example4_nb.ipynb>`_.
