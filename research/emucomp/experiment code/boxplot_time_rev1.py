...
if False:
    ...
    df = pd.DataFrame(d)
    df.to_json(r'./research/emucomp/experiment code/compiled_df.json')
...
p.tick_params(which='minor', axis='x', bottom=False, top=False, labelsize=120)
...
plt.ylabel('Construction time ($s$)', fontsize=16)
