...
parent_datadir = r'C:\Users\moses\Desktop\git\surmise\research\emucomp\experiment code\emulator_PCGPwM_results'
...
df['npts'] = df.n * df.nx * (1- df.failfraction.mean())
