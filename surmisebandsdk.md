...
| 8. |  Have no hardwired print or IO statements that cannot be turned off |Full| There are no mandatory printing.  Any print statements for code feedback in a method can be suppressed via `verbose` argument. |
